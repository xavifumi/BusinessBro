...
func _process(delta: float) -> void:
	...
	var label_diners = get_node("Ux/PantallaSencera/PanellSuperior/MarginContainer/Liquid")
...
static func contracta_treballador(treballador_temp: Dictionary, index: int) -> void:
	llista_treballadors.append(treballador_temp)
	# Afegir treballador
